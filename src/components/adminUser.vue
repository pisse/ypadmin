<template>
  <div class="main">
    ...
    <el-dialog :title="modifyType==1 ? '新建用户': '修改用户'" v-model="dialogUserModifyVisible" size="tiny" custom-class="user-dialog" @close="reset('userModify')">
    ...
    <el-dialog title="编辑权限" v-model="dialogPermissionModifyVisible" size="small" custom-class="modify-dialog" @close="reset('roleModify')">
